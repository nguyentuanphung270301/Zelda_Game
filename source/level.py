...
from setup.debug import *
from source.support import *
from random import choice, randint
from source.weapon import Weapon
from source.ui import UI
from source.enemy import Enemy
from source.particles import Animationplayer
from source.magic import MagicPlayer
from source.upgrade import Upgrade
...
class Level:
    ...
    def create_map(self):
        ...
        graphics = {
            ...
            'object':import_folder('./assets/objects')
        }

        for style,layout in layouts.items():
            for row_index, row in enumerate(layout):
                for col_inedx, col in enumerate(row):
                    if col != '-1':
                        x = col_inedx * TILESIZE
